...
public class Event extends DomainObject {
    ...
    /**
     * Return auditorium with specified date 
     * 
     * @param dateTime Date and time of aired event
     * 
     * @return auditorium if successful, <code>null</code> if {@link Auditorium} 
     *  	is not aired on this date
     */
    public Auditorium getAuditoriumWithAirDate(LocalDateTime dateTime) {
